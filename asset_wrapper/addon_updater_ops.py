...
def register(bl_info):
    ...
    updater.repo = "asset-wrapper"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/Blue-Moon-Virtual/asset-wrapper/"
    ...
    # Asset Wrapper ships a properly-packaged zip on each release, so use it.
